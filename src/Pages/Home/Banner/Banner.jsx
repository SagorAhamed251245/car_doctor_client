    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div
                    className="absolute flex  h-full left-0 top-0 w-full items-center bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                ...
                <div
                    className="absolute flex justify-end gap-5 transform -translate-y-1/2 left-5                      right-5 bottom-0 ">
